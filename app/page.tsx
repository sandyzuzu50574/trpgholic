...
export default function Home() {
  return <main>
    <header className="site-header"><a className="brand" href="#top">ZUZU <span>／</span> TRPG-holic</a><nav aria-label="主要導覽"><a href="#style">我喜歡！</a><a href="#systems">帶過的團</a><a href="#played">跑過的團</a></nav></header>
    ...
    <details className="experience-fold" id="experience"><summary><span className="fold-title"><small>02</small> 我曾做過</span><span className="fold-action">展開查看 ＋</span></summary><div className="experience-grid">
