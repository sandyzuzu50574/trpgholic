...
export default function Home() {
  return <main>
    ...
    <details className="style-fold" id="style"><summary><span className="fold-title"><small>01</small> 我喜歡！</span><span className="fold-action">展開查看 ＋</span></summary><ol className="style-list"><li><span>01</span>理解角色，成為角色的粉絲</li><li><span>02</span>重視共同創作與交流互動</li><li><span>03</span>喜愛即興回應與關係敘事</li><li><span>04</span>玩出系統與劇本的風味</li><li><span>05</span>再加一點我們都喜歡的東西</li></ol></details>
